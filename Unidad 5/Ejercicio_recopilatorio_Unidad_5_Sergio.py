...
print(EPSG_code)
#EPSG code es igual a EPSG:4326. Con el split "caracter" y [1] selecciona todo lo que hay despues del :. El todo es porqué 
#no hay otro elemento para hacer el split. Si lo hubiera te seleccionaría el del número correspondiente.
...
newattributeList=[]
# el -1 en lookupField es verdadero si no encuentra los nombres
...
destination_layer_attrib_names = destination_layer.fields().toList()
print(destination_layer_attrib_names)
